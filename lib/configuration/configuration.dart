class Configuration {
  ...
  Configuration() {
    if (environment == 'dev-home') {
      ...
      oauth2ServerUrl = 'http://10.65.12.142:28080';
      apiServerUrl = 'http://10.65.12.142:18888';
    } else if (environment == 'dev-android') {
      oauth2ServerUrl = 'http://192.168.43.14:28080';
      apiServerUrl = 'http://192.168.43.14:18888';
    } else {
